...
Updated 2026-09-22; inventory snapshot `3be2e64`. The objective covers every published ML blog except loss-function articles. This is a working review record, not a claim that the collection is complete. Reconcile it with the current repository before resuming: other workstreams are adding NLP textbook chapters.

At this snapshot: **226 non-loss articles**, **20 excluded loss-function pages**, and **1 legacy redirect**. New articles need their own review. 14 articles below have completed this improvement pass; a successful navigation check or the presence of a figure does not establish editorial quality.

## Acceptance evidence

- Explain the purpose and prerequisites, define notation before using it, and connect formulas to a consistent worked example.
...
- Finish the identified GBM and ensemble figure/readability gaps.
...
“Reviewed” means a scoped content and visual improvement passed the checks described. “Pending” means the full article has not been accepted in this pass, even if its structure or figures were sampled.
...
| [bagging-and-boosting/bagging-random-forests.html](../blog/ml/bagging-and-boosting/bagging-random-forests.html) | Pending | Individual content, example and visual review outstanding. |
| [bagging-and-boosting/gradient-boosting.html](../blog/ml/bagging-and-boosting/gradient-boosting.html) | Pending | Individual content, example and visual review outstanding. |
...
| [data-preparation/cross-validation/choosing-k.html](../blog/ml/data-preparation/cross-validation/choosing-k.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/cross-validation/cv-for-tuning.html](../blog/ml/data-preparation/cross-validation/cv-for-tuning.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/cross-validation/group-k-fold.html](../blog/ml/data-preparation/cross-validation/group-k-fold.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/cross-validation/index.html](../blog/ml/data-preparation/cross-validation/index.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/cross-validation/k-fold.html](../blog/ml/data-preparation/cross-validation/k-fold.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/cross-validation/leave-one-out.html](../blog/ml/data-preparation/cross-validation/leave-one-out.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/cross-validation/nested-cv.html](../blog/ml/data-preparation/cross-validation/nested-cv.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/cross-validation/repeated-k-fold.html](../blog/ml/data-preparation/cross-validation/repeated-k-fold.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/cross-validation/shuffle-split.html](../blog/ml/data-preparation/cross-validation/shuffle-split.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/cross-validation/stratified-k-fold.html](../blog/ml/data-preparation/cross-validation/stratified-k-fold.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/cross-validation/time-series-cv.html](../blog/ml/data-preparation/cross-validation/time-series-cv.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/data-cleaning/data-types-and-parsing.html](../blog/ml/data-preparation/data-cleaning/data-types-and-parsing.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/data-cleaning/duplicate-records.html](../blog/ml/data-preparation/data-cleaning/duplicate-records.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/data-cleaning/errors-vs-outliers.html](../blog/ml/data-preparation/data-cleaning/errors-vs-outliers.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/data-cleaning/index.html](../blog/ml/data-preparation/data-cleaning/index.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/data-cleaning/text-normalization.html](../blog/ml/data-preparation/data-cleaning/text-normalization.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/data-cleaning/units-and-consistency.html](../blog/ml/data-preparation/data-cleaning/units-and-consistency.html) | Pending | Individual content, example and visual review outstanding. |
...
| [data-preparation/feature-scaling/index.html](../blog/ml/data-preparation/feature-scaling/index.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/feature-scaling/max-abs-and-unit-norm.html](../blog/ml/data-preparation/feature-scaling/max-abs-and-unit-norm.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/feature-scaling/min-max-normalization.html](../blog/ml/data-preparation/feature-scaling/min-max-normalization.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/feature-scaling/normalization-vs-standardization.html](../blog/ml/data-preparation/feature-scaling/normalization-vs-standardization.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/feature-scaling/robust-scaling.html](../blog/ml/data-preparation/feature-scaling/robust-scaling.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/feature-scaling/scaling-sparse-data.html](../blog/ml/data-preparation/feature-scaling/scaling-sparse-data.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/feature-scaling/standardization.html](../blog/ml/data-preparation/feature-scaling/standardization.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/feature-scaling/when-to-scale.html](../blog/ml/data-preparation/feature-scaling/when-to-scale.html) | Pending | Individual content, example and visual review outstanding. |
...
| [data-preparation/train-test-split/data-leakage-in-splitting.html](../blog/ml/data-preparation/train-test-split/data-leakage-in-splitting.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/train-test-split/group-splitting.html](../blog/ml/data-preparation/train-test-split/group-splitting.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/train-test-split/hold-out-split.html](../blog/ml/data-preparation/train-test-split/hold-out-split.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/train-test-split/holdout-vs-cross-validation.html](../blog/ml/data-preparation/train-test-split/holdout-vs-cross-validation.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/train-test-split/index.html](../blog/ml/data-preparation/train-test-split/index.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/train-test-split/reproducibility-and-seeds.html](../blog/ml/data-preparation/train-test-split/reproducibility-and-seeds.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/train-test-split/stratified-splitting.html](../blog/ml/data-preparation/train-test-split/stratified-splitting.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/train-test-split/time-series-splitting.html](../blog/ml/data-preparation/train-test-split/time-series-splitting.html) | Pending | Individual content, example and visual review outstanding. |
| [data-preparation/train-test-split/train-validation-test.html](../blog/ml/data-preparation/train-test-split/train-validation-test.html) | Pending | Individual content, example and visual review outstanding. |
| [decision-trees/deep-dive/bagging-random-forests.html](../blog/ml/decision-trees/deep-dive/bagging-random-forests.html) | Pending | Individual content, example and visual review outstanding. |
| [decision-trees/deep-dive/boosting-adaboost.html](../blog/ml/decision-trees/deep-dive/boosting-adaboost.html) | Pending | Individual content, example and visual review outstanding. |
| [decision-trees/deep-dive/cart-complexity-pruning.html](../blog/ml/decision-trees/deep-dive/cart-complexity-pruning.html) | Pending | Individual content, example and visual review outstanding. |
...
| [decision-trees/deep-dive/index.html](../blog/ml/decision-trees/deep-dive/index.html) | Pending | Individual content, example and visual review outstanding. |
| [decision-trees/deep-dive/threshold-search-edge-cases.html](../blog/ml/decision-trees/deep-dive/threshold-search-edge-cases.html) | Pending | Individual content, example and visual review outstanding. |
...
| [gradient-boosted-machines/modern-gbm.html](../blog/ml/gradient-boosted-machines/modern-gbm.html) | Needs improvement | Add useful row-to-bin-to-statistics figure; existing numerical example is correct. |
...
| [recommended-papers/nlp/bahdanau-2015-attention.html](../blog/ml/recommended-papers/nlp/bahdanau-2015-attention.html) | Needs expansion | Published scaffold; replace placeholders with a complete explanation, evidence and useful figures. |
...
| [regression/families/generalized-linear-models.html](../blog/ml/regression/families/generalized-linear-models.html) | Needs improvement | Replace generic paired bars with topic-specific geometry/distributions; verify worked examples and add primary references. |
...
| [regression/families/pcr-and-pls.html](../blog/ml/regression/families/pcr-and-pls.html) | Needs improvement | Replace generic paired bars with topic-specific geometry/distributions; verify worked examples and add primary references. |
...
| [regression/families/weighted-and-generalized-least-squares.html](../blog/ml/regression/families/weighted-and-generalized-least-squares.html) | Needs improvement | Replace generic paired bars with topic-specific geometry/distributions; verify worked examples and add primary references. |
...
- The Bengio and BPE companion scripts reproduce their original examples with the Python standard library.
- Regression figure generators reproduce smoothing and survival calculations against SciPy; the GBM threshold generator reproduces the three residual-fit diagrams.
